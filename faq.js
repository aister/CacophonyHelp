var content = `<h1>FAQ</h1>

<h2>How can I add songs?</h2>

You can add more songs by first create a folder inside <span class="code">(app folder)/sheets</span> with the name being the name of the song. If you can't find this folder, create one.  
...
<h2>My Mp3 file and GuitarPro file doesn't sync</h2>
...
If you have questions that are not answered in site, please feel free to <a href="contact.html">Contact me</a>
